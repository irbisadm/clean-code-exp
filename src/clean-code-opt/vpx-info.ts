...
const bitDepthLimitations: Record<VpxBitDepth, VpxProfile[]> = {
...
const chromaLimitations: Record<VpxChromaSubsampling, VpxProfile[]> = {
...
export abstract class VpXInfo extends CodecInfo {
  ...
  set chromaSubsampling(chromaSubsampling: VpxChromaSubsampling) {
    ...
    const chromaSubsamplingLimits = chromaLimitations[chromaSubsampling];
